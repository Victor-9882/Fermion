...
d12_3 = ((z + 1.d0)**4 * ( &
    Mtot**4 * (v - 1.d0) * z**2 * (2.d0 * v * (zp + 1.d0) - 1.d0) &
  + 2.d0 * Mtot**3 * mf * (2.d0 * v - 3.d0) * z**2 * (v * zp + v - 1.d0) &
  + 2.d0 * g * Mtot**2 * (16.d0 * v**2 * (zp + 1.d0) + 2.d0 * v * (z * zp + z - 10.d0 * zp - 16.d0) - z + 16.d0) &
  + ((Mtot / 2.d0) - (2.d0 * (g + ms**2) / (Mtot * (z + 1.d0)))) * ( &
        Mtot**3 * z * (8.d0 * v**2 * (zp + 1.d0) + 2.d0 * v * (z * zp + z - 6.d0 * zp - 10.d0) - z + 12.d0) &
      + 2.d0 * Mtot**2 * mf * z * (8.d0 * v**2 * (zp + 1.d0) + 2.d0 * v * (z - 4.d0 * zp - 6.d0) - 3.d0 * z + 4.d0) &
      - 4.d0 * g * Mtot * (2.d0 * v * (4.d0 * z + zp + 1.d0) - 12.d0 * z - 1.d0) &
      + 8.d0 * g * mf * (3.d0 - 2.d0 * v) &
    ) &
  + 2.d0 * Mtot * ((Mtot / 2.d0) - (2.d0 * (g + ms**2) / (Mtot * (z + 1.d0))))**2 * ( &
        Mtot * (4.d0 * v**2 * (zp + 1.d0) - 2.d0 * v * (2.d0 * z**2 + z * zp + z + 2.d0 * zp + 3.d0) + 6.d0 * z**2 + z + 2.d0) &
      + 2.d0 * mf * (2.d0 * v - 3.d0) * (2.d0 * v * (zp + 1.d0) - z - 2.d0) &
    ) &
  + 4.d0 * g * Mtot * mf * (16.d0 * v**2 * (zp + 1.d0) + 2.d0 * v * (z - 2.d0 * (5.d0 * zp + 8.d0)) - 3.d0 * z + 16.d0) &
  + 16.d0 * g**2 * (3.d0 - 2.d0 * v) &
)) / (2.d0 * (Mtot**4 * (z + 1.d0)**4 - 8.d0 * Mtot**2 * (z + 1.d0)**2 * (ms**2 - g) + 16.d0 * (g + ms**2)**2))
